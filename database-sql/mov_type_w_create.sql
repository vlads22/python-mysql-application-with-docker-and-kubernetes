...
CREATE TABLE `type` (
  ...
  `name` varchar(45) NOT NULL COMMENT 'Name of the hardware type, like laptop, monitor, etc.',
  `month_available` varchar(45) DEFAULT NULL COMMENT 'The date at which the item in the name column will be available',
  PRIMARY KEY (`id`)
